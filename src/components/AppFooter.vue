<!-- Source: https://github.com/Beavercreek-Robotics/creekrobotics.org/blob/main/src/components/AppFooter.vue -->
<template>
  <footer class="footer">
        ...
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            <div class="brand-logo">
              ...
              <div>
                <p class="brand-name">Beavercreek Robotics</p>
                <p class="brand-subtitle">FRC Team 5 | Beavercreek High School</p>
              </div>
            </div>
            <p class="brand-desc">
              Empowering the next generation of engineers through competitive robotics, 
              hands-on STEM education, and real-world problem solving since our founding.
            </p>
          ...
          <div class="footer-links">
            ...
            <ul>
              <li><RouterLink to="/students">What is FRC?</RouterLink></li>
              <li><a href="https://www.firstinspires.org/" target="_blank" rel="noopener noreferrer">FIRST Robotics</a></li>
          ...
          <div class="footer-contact">
            ...
            <div class="contact-item">
              ...
              <span>Beavercreek High School<br>2660 Dayton-Xenia Rd<br>Beavercreek, OH 45434</span>
            </div>
            <div class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <span>team5@beavercreekrobotics.org</span>
            </div>
            <div class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <span>Tues &amp; Thurs, 6–9 PM<br>(Build Season)</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p>© 2024 Beavercreek Robotics. All rights reserved.</p>
        <p class="nonprofit-notice">Beavercreek Robotics is a registered 501(c)(3) nonprofit organization.</p>
      </div>
    </div>
  </footer>
</template>
