<!-- Source: https://github.com/Beavercreek-Robotics/creekrobotics.org/blob/main/src/views/ContactView.vue -->
<template>
  <div class="contact-page">
    <HeroSection
      title="Get In Touch"
      subtitle="Whether you're a student, parent, engineer, or business — we'd love to hear from you. We respond to all inquiries within 2 business days."
      backgroundClass="hero-contact"
      :showCta="false"
    />
...
const teamInfo = [
  {
    title: 'Our School',
    content: 'Beavercreek High School<br>2660 Dayton-Xenia Rd<br>Beavercreek, OH 45434',
    iconComponent: {
  ...
  {
    title: 'Email Us',
    content: '<a href="mailto:team5@beavercreekrobotics.org">team5@beavercreekrobotics.org</a>',
    iconComponent: {
  ...
  {
    title: 'FIRST Team Page',
    content: '<a href="https://www.firstinspires.org" target="_blank" rel="noopener noreferrer">View on FIRST Inspires →</a>',
    iconComponent: {
...
const meetingSchedule = [
  {
    ...
    time: '6:00 PM – 9:00 PM + Saturday sessions'
  },
  {
    period: 'Off-Season (May–Dec)',
    days: 'Varies by sub-team',
    time: 'Check with team leads for schedule'
  },
  {
    period: 'Competitions',
    days: 'As scheduled',
    time: '2–3 regional events per year'
  },
]
</script>
...
.success-message strong { display: block; color: #276749; margin-bottom: 0.25rem; }
.success-message p { font-size: 0.875rem; color: #2d6a4f; margin: 0; }
